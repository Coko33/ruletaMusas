...
let nombreMusa = document.getElementById("nombreMusa");
let textoMusa = document.getElementById("textoMusa");
let descripcionMusa = document.getElementById("descripcionMusa");
...
window.addEventListener("load", function () {
  ...
  ini.addEventListener("click", function () {
    figusContainer.style.display = "grid";
    ...
    rolando = setTimeout(function tick() {
      if (counter < VUELTAS) {
        ...
        ms = 50;
        setTimeout(() => {
          nombreMusa.textContent = musas[elNum - 1].nombre;
          descripcionMusa.textContent = musas[elNum - 1].descripcion;
          textoMusa.style.display = "block";
        }, 1000);
      }
    }, ms);
  });
